...
<tileset version="1.10" tiledversion="1.10.0" name="evergreen trees, tree wall (autumn, canopy only) 128x128" tilewidth="128" tileheight="128" tilecount="24" columns="6">
 <image source="../evergreen trees, tree wall (autumn, canopy only) 128x128.png" width="768" height="512"/>
 <wangsets>
